...
<div class="container pb-6 pt-6">
	...
	<p class="has-text-centered pb-6"><?php  echo "<strong>Usuario creado:</strong> Fecha ".date("d-m-Y  h:i:s A",strtotime($datos['usuario_creado']))." &nbsp; <strong>Usuario actualizado:</strong> ".date("d-m-Y  h:i:s A",strtotime($datos['usuario_actualizado'])) ?>;</p>
