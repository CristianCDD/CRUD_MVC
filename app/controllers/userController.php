...
class userController extends mainModel{
    ...
    public function actualizarFotoUsuarioControlador(){
        ...
        if($datos['usuario_foto'] != ''){
            ...
            $foto = str_ireplace("", "_", $datos['usuario_foto'] );
            //Ejemplo "Cristian Damian => Cristian_Damian_10"
            $foto = $foto . "_" . rand(0, 100);
        }
        ...
        if ($this->actualizarDatos("usuario", $usuario_datos_up, $condicion)) {
            ...
            $alerta = [
                ...
                "texto" => "La foto del usuario " . $datos['usuario_nombre'] . " " . $datos['usuario_apellido'] . " se actualizo con exito",
                "icono" => "success"
            ];
        } else {
            ...
            $alerta = [
                ...
                "texto" => "No hemos podido actualizar algunos datos del usuario " . $datos['usuario_nombre'] . " " . $datos['usuario_apellido'] . " se actualizo con exito",
                "icono" => "warning"
            ];
        }
    ...
    public function eliminarFotoUsuarioControlador(){
        ...
        if(is_file($img_dir.$datos['usuario_foto'])){
            ...
            if(!unlink($img_dir.$datos['usuario_foto'])){
                $alerta = [
                    "tipo" => "simple",
                    "titulo" => "Ocurrió un error inesperado",
                    "texto" => "Error al intentar eliminar la foto",
                    "icono" => "error"
                ];
                return json_encode($alerta);
                exit();
        ...
        if ($this->actualizarDatos("usuario", $usuario_datos_up, $condicion)) {
            ...
            $alerta = [
                ...
                "texto" => "La foto del usuario " . $datos['usuario_nombre'] . " " . $datos['usuario_apellido'] . " se elimino con exito",
                "icono" => "success"
            ];
        } else {
            ...
            $alerta = [
                "tipo" => "recargar",
                "titulo" => "Foto eliminada",
                "texto" => "No hemos podido eliminar algunos datos del usuario " . $datos['usuario_nombre'] . " " . $datos['usuario_apellido'] . " se elimino con exito",
                "icono" => "warning"
            ];
        }
